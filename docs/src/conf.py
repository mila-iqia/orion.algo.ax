# -*- coding: utf-8 -*-
#
# orion.algo.ax documentation build configuration file.
#
...
import orion.algo.ax as algo_plugin
...
man_pages = [(master_doc, "projectname", "Oríon algo ax Documentation", [author], 1)]
